...
export const SALON_MEDSPA_MODULES: PlaybookModule[] = [
  { id: 0, title: "The Playbook", eyebrow: "Welcome", section: "Foundation", readTime: "2 min" },
  { id: 1, title: "The Market Opportunity", eyebrow: "Salon & Med Spa", section: "Foundation", readTime: "3 min" },
...
export const SALON_MEDSPA_MODULE_SECTIONS: ModuleSection[] = [
  "Foundation",
  "Products",
  "Sales",
  "Reference",
