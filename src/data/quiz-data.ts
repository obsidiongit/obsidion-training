...
export const QUIZ_DATA: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    feedback: "7 days is the average. This timeline separates Obsidion from agencies that take months."
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    feedback: "Single locations range from $5,000 to $8,000. Multi-location setups increase to $8,000–$12,000."
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    feedback: "Three tiers: Essentials ($597), Growth ($997), Premium ($1,497). This accounts for the complexity and revenue potential of the market."
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    feedback: "Advertising restrictions force dispensaries to rely on organic search and their website as the primary acquisition channels."
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    feedback: "$15,000–$25,000. Position this as a premium asset for multi-location operators and MSOs."
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    feedback: "Paid Meta campaigns are excluded. The retainer handles SEO, remarketing, hosting, reviews, and analytics."
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    feedback: "Start with the relationship. Find the operational pain point, then present Obsidion as the specific solution."
  },
  {
    id: 9,
    question: "When a prospect states 'We already have a website,' what is the proper response?",
    options: [
    ...
    correctAnswer: 1,
    feedback: "Shift focus to performance. Most sites exist but fail to work. Propose a performance audit to uncover gaps."
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    feedback: "Paid acquisition is heavily restricted. SMS, email, and loyalty programs active the existing customer base without ad spend."
  },
  {
    id: 11,
  ...
  },
  {
    ...
    correctAnswer: 2,
    feedback: "Instagram is where operators spend time. DMs must be personalized with a specific question, not a generic pitch."
  }
];
