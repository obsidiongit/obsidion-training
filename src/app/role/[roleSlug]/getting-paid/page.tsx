    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed mb-8">
          Compensation structure, commission tiers, bonus programs, and payout schedule.
        </p>
        <div className="rounded-2xl border border-dashed border-border bg-muted/10 p-8 text-center">
          <p className="text-muted-foreground">Content coming soon — see <code className="text-xs bg-muted px-1.5 py-0.5 rounded">content/roles/account-executive/getting-paid.md</code> for the outline.</p>
        </div>
      </div>
    </div>
  );
