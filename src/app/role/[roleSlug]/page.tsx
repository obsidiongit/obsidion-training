            ...
            <div className="rounded-2xl border border-border bg-card p-5 sm:p-6 shadow-sm space-y-5">
              ...
              <div className="border-t border-border/60 pt-5">
                <a
                  ...
                  className="group flex items-center justify-center gap-3 rounded-xl border border-purple-accent/20 bg-purple-accent/[0.04] p-4 transition-all hover:border-purple-accent/40 hover:bg-purple-accent/[0.08] hover:-translate-y-0.5"
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0 text-purple-accent" fill="currentColor">
                  ...
                  <div className="text-center sm:text-left">
                    <span className="text-sm font-bold text-foreground group-hover:text-purple-accent transition-colors">
                      Join Our Discord
                    </span>
                    <span className="block text-[11px] text-muted-foreground">
                      Daily meetings, team chat & manager access
                    </span>
                  </div>
                  <ChevronRight size={14} className="shrink-0 text-muted-foreground group-hover:text-purple-accent transition-colors" />
                </a>
              </div>
            </div>
          </motion.section>
