...
export default function ContractorsModule10Quiz() {
    ...
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-500 max-w-4xl space-y-12 pb-20">
      <div>
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Verify your comprehension of the Contractors playbook. Score at least {need}/{n} to mark
          this playbook complete on this device and unlock the completion actions below.
        </p>
      </div>
