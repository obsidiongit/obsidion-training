...
export default function Module07PricingAutomotive() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-500 max-w-4xl space-y-12">
      <div>
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Know these metrics. Confidence in pricing dictates confidence in the product. We do not
        ...
        <CardGrid cols={2}>
          <Card>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>→ Scheduling / shop software integration</li>
              <li>→ Service menus, proof, and location structure</li>
      ...
      <div>
        ...
        <CardGrid cols={3}>
          ...
          <Card>
            ...
            <p className="text-muted-foreground text-xs border-b pb-4 mb-4">Multi-location & aggressive growth</p>
            <ul className="space-y-2 text-xs text-muted-foreground mt-4">
      ...
      <div className="mt-8 border p-6 rounded-xl bg-card">
        ...
        <div className="flex justify-between items-end border-b pb-4 mb-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Multi-location / high-database standard play</p>
          </div>
        ...
        <ul className="grid grid-cols-2 gap-2 text-sm text-muted-foreground mt-4">
          ...
          <li>→ Loyalty system & booking hub</li>
          <li>→ Offers synced with site</li>
          <li>→ Shared operational backend</li>
        </ul>
      </div>

      <HighlightBox variant="warning" title="Pricing Context">
        Competing local SEO agencies charge $1,000–$2,500/month for SEO alone—excluding website management, remarketing tools, and automation. Our Growth package ($997) delivers the entire stack. Frame the discussion: &ldquo;Hire an SEO agency for the same capital and receive a fraction of the utility, or deploy an entire digital operation through us.&rdquo; The fiscal value is undeniable.
      </HighlightBox>
