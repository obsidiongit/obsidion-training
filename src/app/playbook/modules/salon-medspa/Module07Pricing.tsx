  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-500 max-w-4xl space-y-12">
        ...
        <CardGrid cols={2}>
          <Card>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>→ Scheduling / POS integration (Mindbody, Vagaro, etc.)</li>
              <li>→ Service menus, providers, med spa treatment structure</li>
          ...
          <Card>
            <div className="text-xs font-bold text-accent uppercase tracking-wider mb-2">Setup Fee</div>
            <h3 className="text-2xl font-black mb-1">Multi-Location</h3>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>→ Unified backend across studios</li>
        ...
        <CardGrid cols={3}>
          ...
          <Card variant="green">
            ...
            <ul className="space-y-2 text-xs text-muted-foreground mt-4">
              ...
              <li>→ Loyalty / membership support</li>
          ...
          <Card>
            ...
            <p className="text-muted-foreground text-xs border-b pb-4 mb-4">Multi-site &amp; aggressive growth</p>
            <ul className="space-y-2 text-xs text-muted-foreground mt-4">
      ...
      <div className="mt-8 border p-6 rounded-xl bg-card">
        ...
        <div className="flex justify-between items-end border-b pb-4 mb-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Multi-location &amp; high-volume standard</p>
          </div>
        ...
        <ul className="grid grid-cols-2 gap-2 text-sm text-muted-foreground mt-4">
          ...
          <li>→ Push notifications &amp; geo prompts</li>
          <li>→ Loyalty &amp; booking-first UX</li>
      ...
      <HighlightBox variant="warning" title="Pricing Context">
        Pure-play SEO shops often charge $1,000–$2,500/month for SEO alone—without site stewardship,
        automation, or retention. Our Growth package ($997) delivers the full stack. Frame it: same
