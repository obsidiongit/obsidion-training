...
const SUCCESS_ITEMS = [
  ...
  },
  {
    ...
    icon: Database,
    items: [
      "The Outreach Dashboard is always current. Daily activity logged. Every appointment documented with full handoff notes.",
...
const EXIT_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Neglecting the Outreach Dashboard. Empty records make your work invisible.",
    ],
  },
  {
...
const CHECKPOINTS = [
  {
    ...
    items: ["All training completed", "Profiles set up", "Dashboard active", "Outreach started", "Booking a few per week"],
  ...
  },
  {
    ...
    items: ["1-2 appointments/day consistently", "Show rate above 70%", "Dashboard current", "All three channels active", "Feedback being implemented"],
            ...
            {[
              {
                ...
                detail: "Targets hit. Activity consistent. Dashboard current. Show rate high. AEs closing your appointments.",
              },
              {
